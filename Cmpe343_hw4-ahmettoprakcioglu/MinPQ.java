...
//Section: 1
//Assignment: 4
//Description: This class defines a MinPq
//-----------------------------------------------------
...
public class MinPQ<Key> implements Iterable<Key> {
	...
	// Precondition:pq is an object.
	// Postcondition: The object is setted.
	// --------------------------------------------------------------
	...
	// --------------------------------------------------------------
	// Summary: Initializes an empty priority queue with the given initial
	...
	// --------------------------------------------------------------
	// Summary: Initializes a priority queue from the array of keys. Takes time
	...
	// --------------------------------------------------------------
	// Summary: Returns a smallest key on this priority queue. A smallest key on
	// this priority queue.
	// Precondition: There is no precondition.
	// Postcondition: There is no postcondition.
	// --------------------------------------------------------------
	...
	// --------------------------------------------------------------
	// Summary: Removes and returns a smallest key on this priority queue. a
	// smallest key on this priority queue
	// Precondition: There is no precondition.
	// Postcondition: There is no postcondition.
	// --------------------------------------------------------------
	public Key delMin() {
	...
	// --------------------------------------------------------------
	// Summary: Is subtree of pq[1..n] rooted at k a min heap?
	// Precondition: There is no precondition.
	// Postcondition: There is no postcondition.
	// --------------------------------------------------------------
